...
/* comment.html.twig */
class __TwigTemplate_0785a088fed5a877a2fe39dec177f007d97d76125dba03184692b9b27e8604ac extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"form-group\">
        ...
        ";
        // line 7
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 7, $this->source); })()), 'rest');
        echo "
        <input value=\"";
        // line 8
...
";
    ...
    {
        return array (  85 => 10,  80 => 8,  76 => 7,  72 => 6,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{% block body %}
    ...
    <br><br>
{% endblock %}", "comment.html.twig", "C:\\wamp64\\www\\partiel_symfony\\templates\\comment.html.twig");
    }
}
